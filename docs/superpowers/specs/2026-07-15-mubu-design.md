...
> **命名**: 产品名 **织念**（原「幕布」）；路由与表名仍为 `mubu` / `mubu_*`
...
- 文档列表：新建 / 删除（**删除须 `ConfirmDialog` 二次确认**）
- 笔记视图：圆点菜单、引导线、折叠；Tab / Enter / Backspace / ↑↓
- **主题菜单**（**右键**主题行打开，**不含备注/描述**）：标题级别 H1–H3、粗体/斜体/下划线/删除线、字体颜色、荧光笔、待办、图标、删除（**删除须二次确认**；含子主题时提示一并删除）
- 导图视图：根胶囊 → 一级浅框 → 二级+底线
