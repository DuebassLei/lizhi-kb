...
<template>
  ...
  <div class="flex h-full items-center justify-center bg-base p-8">

    <div

      class="w-full max-w-sm rounded-xl border border-border bg-surface-1 px-8 py-10"
    ...
    >
      ...
      <div class="mt-4 flex rounded-md bg-surface-0 p-0.5 text-xs" role="tablist">
